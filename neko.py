...
import random
from data.vars import api_id, api_hash, bot_token, admin_users, users, temp_users, vip_users, MAIN_ADMIN, CODEWORD, BOT_IS_PUBLIC, PROTECT_CONTENT, allowed_ids, allowed_users
nest_asyncio.apply()
